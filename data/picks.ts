...
/** Second batch of the owner's Amazon affiliate links, checked and added on this date. */
const SECOND_BATCH_DATE = '2026-09-15'
...
export const PICKS: Pick[] = [
  ...
  // --- Second Amazon batch, added 2026-09-15 --------------------------------
  {
    id: 'p036',
    slug: 'funko-pop-demon-slayer-nezuko-kamado',
    title: 'Funko Pop! Animation: Demon Slayer – Nezuko Kamado',
    whyWePicked: [
      "Funko's official Demon Slayer licence, stated on the box and the listing.",
      'The standard 3.75 in Pop! size, so it sits in any Pop! shelf or protector case.',
      'Sold and shipped by Amazon.com directly.',
    ],
    bestFor: 'A first Demon Slayer piece, or filling the gap next to a Tanjiro Pop!',
    watchOut: 'Common Pop!, so prices swing a few dollars week to week. Check the dated price before buying elsewhere.',
    description: "Funko's officially licensed 3.75-inch Pop! vinyl of Nezuko Kamado from Demon Slayer.",
    merchantId: 'amazon',
    sellerType: 'licensed_retailer',
    licenseStatus: 'officially_licensed',
    goSlug: 'funko-pop-demon-slayer-nezuko-kamado',
    purchaseUrl: 'https://www.amazon.com/dp/B083MCTX7F',
    price: 11.19,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/71ubHqcsvWL._AC_SL1300_.jpg', alt: 'Funko Pop! Nezuko Kamado vinyl figure', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Figures & Collectibles',
    collections: ['collector-arc'],
    tags: ['funko', 'demon slayer', 'vinyl', 'giftable'],
    alternatives: ['p018', 'p024'],
    addedAt: SECOND_BATCH_DATE,
    featured: true,
  },
  {
    id: 'p037',
    slug: 'funko-pop-naruto-uzumaki-running',
    title: 'Funko Pop! Animation: Naruto – Naruto Uzumaki Running',
    whyWePicked: [
      "Funko's official Naruto licence, stated on the box and the listing.",
      'A running pose rather than the usual standing Pop!, so it reads as Naruto from across the room.',
      'Sold and shipped by Amazon.com directly.',
    ],
    bestFor: 'A Naruto fan who wants one figure on the desk, not a shelf of them',
    watchOut: 'Vaulted-and-reissued Pop! lines like this one sometimes ship in dented boxes from Amazon. Box collectors should check on arrival.',
    description: "Funko's officially licensed 3.75-inch Pop! vinyl of Naruto Uzumaki in his running pose.",
    merchantId: 'amazon',
    sellerType: 'licensed_retailer',
    licenseStatus: 'officially_licensed',
    goSlug: 'funko-pop-naruto-uzumaki-running',
    purchaseUrl: 'https://www.amazon.com/dp/B07XB241MQ',
    price: 12.87,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/71AjrkMQFkL._AC_SL1500_.jpg', alt: 'Funko Pop! Naruto Uzumaki running vinyl figure', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Figures & Collectibles',
    collections: ['collector-arc'],
    tags: ['funko', 'naruto', 'vinyl', 'giftable'],
    alternatives: ['p030', 'p033'],
    addedAt: SECOND_BATCH_DATE,
  },
  {
    id: 'p038',
    slug: 'funko-pop-dragon-ball-z-goku-kamehameha',
    title: 'Funko Pop! Animation: Dragon Ball Z – Goku with Kamehameha Wave',
    whyWePicked: [
      "Funko's official Dragon Ball Z licence, stated on the box and the listing.",
      'The Kamehameha effect piece gives it more presence than a plain standing Goku.',
      'Sold and shipped by Amazon.com directly.',
    ],
    bestFor: 'Pairing with the Vegeta Pop! below for a two-figure desk set',
    watchOut: 'The translucent blue effect is glued to the hands. It is not removable and can arrive slightly tilted.',
    description: "Funko's officially licensed 3.75-inch Pop! vinyl of Goku firing a Kamehameha, from Dragon Ball Z.",
    merchantId: 'amazon',
    sellerType: 'licensed_retailer',
    licenseStatus: 'officially_licensed',
    goSlug: 'funko-pop-dragon-ball-z-goku-kamehameha',
    purchaseUrl: 'https://www.amazon.com/dp/B08LQ591C3',
    price: 15.18,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/71G1GsgeCIL._AC_SL1300_.jpg', alt: 'Funko Pop! Goku with Kamehameha wave vinyl figure', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Figures & Collectibles',
    collections: ['collector-arc'],
    tags: ['funko', 'dragon ball', 'vinyl', 'giftable'],
    alternatives: ['p039', 'p024'],
    addedAt: SECOND_BATCH_DATE,
  },
  {
    id: 'p039',
    slug: 'funko-pop-dragon-ball-z-vegeta',
    title: 'Funko Pop! Animation: Dragon Ball Z – Vegeta',
    whyWePicked: [
      "Funko's official Dragon Ball Z licence, stated on the box and the listing.",
      'One of the longest-running Pop! designs in the line, so replacements are easy to find if it breaks.',
      'Sold and shipped by Amazon.com directly.',
    ],
    bestFor: 'The other half of a Goku and Vegeta pair',
    watchOut: 'An older mould. The face sculpt is simpler than newer Dragon Ball Pop! releases.',
    description: "Funko's officially licensed 3.75-inch Pop! vinyl of Vegeta from Dragon Ball Z.",
    merchantId: 'amazon',
    sellerType: 'licensed_retailer',
    licenseStatus: 'officially_licensed',
    goSlug: 'funko-pop-dragon-ball-z-vegeta',
    purchaseUrl: 'https://www.amazon.com/dp/B00KZFY812',
    price: 14.95,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/61rQq69ccXL._AC_SL1300_.jpg', alt: 'Funko Pop! Vegeta vinyl figure', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Figures & Collectibles',
    collections: ['collector-arc'],
    tags: ['funko', 'dragon ball', 'vinyl', 'giftable'],
    alternatives: ['p038', 'p033'],
    addedAt: SECOND_BATCH_DATE,
  },
  {
    id: 'p040',
    slug: 'hldmyyxgs-demon-slayer-style-figure-set-3-pack',
    title: 'HLDMYYXGS Demon Slayer-Style Figure Set, 3 Pack, 8.6 in',
    whyWePicked: [
      'Three 8.6 in figures for the price of one branded prize figure.',
      'Large enough to read as a display piece rather than a desk trinket.',
      'Ships from a marketplace seller with Amazon returns, so it can go back if the paint is rough.',
    ],
    bestFor: 'Readers who want big shelf presence on a small budget and have checked the maker themselves',
    watchOut:
      'The listing avoids naming the series and names no licensor, and the brand has no presence outside marketplaces. We have not been able to verify a licence.',
    description: 'A three-figure set of 8.6-inch Demon Slayer-style anime figures sold under the HLDMYYXGS brand.',
    merchantId: 'amazon',
    sellerType: 'marketplace',
    licenseStatus: 'unverified',
    goSlug: 'hldmyyxgs-demon-slayer-style-figure-set-3-pack',
    purchaseUrl: 'https://www.amazon.com/dp/B0GSFZMB3X',
    price: 29.99,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/71uPuy29-sL._AC_SL1500_.jpg', alt: 'Set of three 8.6-inch Demon Slayer-style anime figures', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Figures & Collectibles',
    collections: ['collector-arc'],
    tags: ['figure', 'demon slayer', 'set'],
    alternatives: ['p018', 'p036'],
    addedAt: SECOND_BATCH_DATE,
  },
  {
    id: 'p041',
    slug: 'sega-figurizm-toji-fushiguro-encounter',
    title: 'SEGA Figurizmα Toji Fushiguro "Encounter" Figure',
    whyWePicked: [
      "SEGA's Figurizmα line is an officially licensed Jujutsu Kaisen prize series, and the listing states the licence.",
      'Completes the "Encounter" set with the Megumi and Mahoraga figures already in the catalog.',
      'Base stand included, so it stands without a separate riser.',
    ],
    bestFor: 'Collectors building the Encounter trio, or anyone whose favourite arc is Shibuya',
    watchOut:
      'Sold by a third-party marketplace seller, not Amazon. Look for the SEGA and Bandai warning labels on the box as proof of an authentic import.',
    description: "SEGA's officially licensed Figurizmα prize figure of Toji Fushiguro from Jujutsu Kaisen, Encounter version, with base.",
    merchantId: 'amazon',
    sellerType: 'marketplace',
    licenseStatus: 'officially_licensed',
    goSlug: 'sega-figurizm-toji-fushiguro-encounter',
    purchaseUrl: 'https://www.amazon.com/dp/B0CWDM9WVC',
    price: 44.8,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/515fGOYbCcL._AC_SL1000_.jpg', alt: 'SEGA Figurizm Toji Fushiguro Encounter figure', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Figures & Collectibles',
    collections: ['collector-arc'],
    tags: ['figure', 'jujutsu kaisen', 'sega', 'prize figure'],
    alternatives: ['p016', 'p023'],
    addedAt: SECOND_BATCH_DATE,
    featured: true,
  },
  {
    id: 'p042',
    slug: 'taito-marin-kitagawa-shizuku-kuroe-figure',
    title: 'Taito My Dress-Up Darling Marin Kitagawa Figure, Shizuku Kuroe Ver.',
    whyWePicked: [
      "Taito's official My Dress-Up Darling licence, stated on the listing.",
      'The Shizuku cosplay version is the outfit most fans associate with the first season.',
      'Base stand included.',
    ],
    bestFor: 'A My Dress-Up Darling fan who wants a proper prize figure rather than a Pop!',
    watchOut:
      'Sold by a third-party marketplace seller with low stock at the time of checking. Prize figures are made in one run, so the price will climb once it sells through.',
    description: "Taito's officially licensed prize figure of Marin Kitagawa in her Shizuku Kuroe cosplay, from My Dress-Up Darling.",
    merchantId: 'amazon',
    sellerType: 'marketplace',
    licenseStatus: 'officially_licensed',
    goSlug: 'taito-marin-kitagawa-shizuku-kuroe-figure',
    purchaseUrl: 'https://www.amazon.com/dp/B0DTP3MTX1',
    price: 34.99,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/71z2s+0lSDL._AC_SL1500_.jpg', alt: 'Taito Marin Kitagawa Shizuku Kuroe version figure', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Figures & Collectibles',
    collections: ['collector-arc'],
    tags: ['figure', 'my dress-up darling', 'taito', 'prize figure'],
    alternatives: ['p041', 'p018'],
    addedAt: SECOND_BATCH_DATE,
  },
  {
    id: 'p043',
    slug: 'ylqanong-mha-bakugo-17cm-figure',
    title: 'YLQANONG My Hero Academia Bakugo 17 cm Figure',
    whyWePicked: [
      'Desk-sized at about 6.7 in, so it fits beside a monitor.',
      'Very cheap for a painted PVC piece.',
      'Ships from a marketplace seller with Amazon returns, so it can go back if the paint is rough.',
    ],
    bestFor: 'Readers who want a desk-sized Bakugo and have checked the maker themselves',
    watchOut:
      'The listing names no licensor, lists half the cast in its own title, and the brand has no presence outside marketplaces. We have not been able to verify a licence.',
    description: 'A 17 cm Katsuki Bakugo PVC figure from My Hero Academia, sold under the YLQANONG brand.',
    merchantId: 'amazon',
    sellerType: 'marketplace',
    licenseStatus: 'unverified',
    goSlug: 'ylqanong-mha-bakugo-17cm-figure',
    purchaseUrl: 'https://www.amazon.com/dp/B0G25BJ7CB',
    price: 12.99,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/61f0QAVVPyL._AC_SL1001_.jpg', alt: 'Katsuki Bakugo 17 cm PVC figure', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Figures & Collectibles',
    collections: ['collector-arc'],
    tags: ['figure', 'my hero academia', 'desk'],
    alternatives: ['p021', 'p045'],
    addedAt: SECOND_BATCH_DATE,
  },
  {
    id: 'p044',
    slug: 'banpresto-one-piece-luffy-gear-5-king-of-artist',
    title: 'Banpresto One Piece King of Artist Monkey D. Luffy Gear 5 II',
    whyWePicked: [
      "Bandai Spirits' Banpresto line is officially licensed, and the box carries the Bandai Namco warning label that proves it.",
      'The Gear 5 design is the most requested Luffy figure since the Egghead arc aired.',
      'About 5.9 in tall in a dynamic pose, so it holds a shelf on its own.',
    ],
    bestFor: 'A One Piece fan who wants a real prize figure at a Pop! price',
    watchOut: 'Sold by a third-party marketplace seller, not Amazon. Check for the Bandai Namco label on the box when it arrives.',
    description: "Banpresto's officially licensed King of Artist prize figure of Monkey D. Luffy in Gear 5, second version, from One Piece.",
    merchantId: 'amazon',
    sellerType: 'marketplace',
    licenseStatus: 'officially_licensed',
    goSlug: 'banpresto-one-piece-luffy-gear-5-king-of-artist',
    purchaseUrl: 'https://www.amazon.com/dp/B0CXHP15W5',
    price: 26.5,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/717usaR1ElL._AC_SL1500_.jpg', alt: 'Banpresto King of Artist Luffy Gear 5 figure', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Figures & Collectibles',
    collections: ['collector-arc'],
    tags: ['figure', 'one piece', 'banpresto', 'prize figure', 'giftable'],
    alternatives: ['p018', 'p041'],
    addedAt: SECOND_BATCH_DATE,
    featured: true,
  },
  {
    id: 'p045',
    slug: 'mabaiude-mha-bakugo-19cm-figure',
    title: 'MABAIUDE My Hero Academia Bakugo 19 cm Figure',
    whyWePicked: [
      'About 7.5 in in a standing pose, a step up in size from most desk figures at this price.',
      'Very cheap for a painted PVC piece.',
      'Ships from a marketplace seller with Amazon returns, so it can go back if the paint is rough.',
    ],
    bestFor: 'Readers who want a larger Bakugo for a shelf and have checked the maker themselves',
    watchOut:
      'The listing names no licensor and the brand has no presence outside marketplaces. We have not been able to verify a licence.',
    description: 'A 19 cm standing Katsuki Bakugo PVC figure from My Hero Academia, sold under the MABAIUDE brand.',
    merchantId: 'amazon',
    sellerType: 'marketplace',
    licenseStatus: 'unverified',
    goSlug: 'mabaiude-mha-bakugo-19cm-figure',
    purchaseUrl: 'https://www.amazon.com/dp/B0H1CGX7LV',
    price: 14.99,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/51TedCLxuML._AC_SL1001_.jpg', alt: 'Katsuki Bakugo 19 cm standing PVC figure', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Figures & Collectibles',
    collections: ['collector-arc'],
    tags: ['figure', 'my hero academia', 'desk'],
    alternatives: ['p021', 'p043'],
    addedAt: SECOND_BATCH_DATE,
  },
  {
    id: 'p046',
    slug: 'one-piece-crew-socks-5-pack',
    title: 'One Piece Crew Socks, 5 Pack',
    whyWePicked: [
      'Five pairs with a different Straw Hat design on each.',
      'Crew length, so the print shows above a sneaker.',
      'Ships from a marketplace seller with Amazon returns.',
    ],
    bestFor: 'A cheap stocking-filler for a One Piece fan',
    watchOut:
      'The brand field just says "One Piece" and the listing names no licensee or manufacturer. We have not been able to verify a licence.',
    description: 'A five-pack of One Piece printed crew socks sold through a marketplace seller.',
    merchantId: 'amazon',
    sellerType: 'marketplace',
    licenseStatus: 'unverified',
    goSlug: 'one-piece-crew-socks-5-pack',
    purchaseUrl: 'https://www.amazon.com/dp/B0DQVC46HM',
    price: 19,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/91PWHa+HFOL._AC_SL1500_.jpg', alt: 'Five pairs of One Piece printed crew socks', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Apparel',
    collections: ['streetwear-arc'],
    tags: ['socks', 'one piece', 'giftable'],
    alternatives: ['p015', 'p047'],
    addedAt: SECOND_BATCH_DATE,
  },
  {
    id: 'p047',
    slug: 'juejuezi-tanjiro-pattern-hooded-blanket',
    title: 'Juejuezi Tanjiro-Pattern Hooded Wearable Blanket',
    whyWePicked: [
      'A 63 × 40 in wearable blanket in the green-and-black check of Tanjiro\'s haori.',
      'Doubles as a lap blanket for a cold desk.',
      'Ships from a marketplace seller with Amazon returns.',
    ],
    bestFor: 'Winter desk sessions, or a low-effort convention cosplay',
    watchOut:
      'The listing never names Demon Slayer or a licensor, only "cosplay". This is a pattern lookalike, not licensed merchandise.',
    description: 'A 160 × 100 cm hooded wearable blanket in a Tanjiro-style check pattern, sold under the Juejuezi brand.',
    merchantId: 'amazon',
    sellerType: 'marketplace',
    licenseStatus: 'unverified',
    goSlug: 'juejuezi-tanjiro-pattern-hooded-blanket',
    purchaseUrl: 'https://www.amazon.com/dp/B0BTVN2FDW',
    price: 26.99,
    currency: 'USD',
    priceCheckedAt: '2026-09-15',
    images: [{ src: 'https://m.media-amazon.com/images/I/61HPx1LfhgL._AC_SL1500_.jpg', alt: 'Hooded wearable blanket in a green and black check pattern', source: 'merchant_listing' }],
    lastVerifiedAt: SECOND_BATCH_DATE,
    linkStatus: 'ok',
    category: 'Apparel',
    collections: ['streetwear-arc'],
    tags: ['blanket', 'demon slayer', 'cosplay'],
    alternatives: ['p015', 'p046'],
    addedAt: SECOND_BATCH_DATE,
  },
]
